...
- `OVERWRITE_ALL` (default `0`, set `1` to overwrite all rendered pages, OCR outputs, and merged markdown)
...
- `DEEPSEEK_BASE_SIZE` (default `1024`, DeepSeek infer `base_size`)
- `DEEPSEEK_IMAGE_SIZE` (default `768`, DeepSeek infer `image_size`)
